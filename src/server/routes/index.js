...
const contactUsMailer = require('../middlewares/contactUsMailer');
const SubmitQuery = require('../middlewares/submitQuery');

router.post(('/submit_query'), ContentTypeValidation, validate(contactValidation, {}, {}), contactUsMailer, SubmitQuery, (req, res) => {
